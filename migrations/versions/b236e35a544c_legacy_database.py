...
def upgrade() -> None:
    ...
    op.create_table('tbl_operating_system',
    ...
    op.create_table('tbl_report_type',
    ...
    op.create_table('tbl_restriction_type',
    ...
    op.create_table('tbl_scrape_history',
    ...
    sa.ForeignKeyConstraint(['scrape_id'], ['tbl_scrape_history.scrape_id'], ),
    sa.PrimaryKeyConstraint('faculty_id'),
    sa.UniqueConstraint('banner_id')
    )
    op.create_table('tbl_report',
    ...
    sa.ForeignKeyConstraint(['browser_description'], ['tbl_browser.browser_id'], ),
    sa.ForeignKeyConstraint(['operating_system'], ['tbl_operating_system.os_id'], ),
    sa.ForeignKeyConstraint(['report_type'], ['tbl_report_type.report_type_id'], ),
    sa.PrimaryKeyConstraint('report_id')
    )
    op.create_table('tbl_restriction',
    ...
    sa.ForeignKeyConstraint(['restriction_type'], ['tbl_restriction_type.restriction_type_id'], ),
    sa.PrimaryKeyConstraint('restriction_id')
    )
    op.create_table('tbl_school',
    ...
    sa.ForeignKeyConstraint(['scrape_id_last'], ['tbl_scrape_history.scrape_id'], ),
    sa.PrimaryKeyConstraint('school_id')
    )
    op.create_table('tbl_term',
    ...
    sa.ForeignKeyConstraint(['school_id'], ['tbl_school.school_id'], ),
    ...
    sa.ForeignKeyConstraint(['class_type_id'], ['tbl_classtype.class_type_id'], ),
    sa.ForeignKeyConstraint(['course_id'], ['tbl_course.course_id'], ),
    sa.ForeignKeyConstraint(['scrape_id'], ['tbl_scrape_history.scrape_id'], ),
    sa.ForeignKeyConstraint(['subject_id'], ['tbl_subject.subject_id'], ),
    ...
    sa.ForeignKeyConstraint(['course_data_id'], ['tbl_course_data.course_data_id'], ),
    sa.ForeignKeyConstraint(['faculty_id'], ['tbl_faculty.faculty_id'], ),
    sa.PrimaryKeyConstraint('course_data_id', 'faculty_id')
    )
    op.create_table('tbl_course_restriction',
    sa.Column('course_data_id', sa.Integer(), nullable=False),
    sa.Column('restriction_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['course_data_id'], ['tbl_course_data.course_data_id'], ),
    sa.ForeignKeyConstraint(['restriction_id'], ['tbl_restriction.restriction_id'], ),
    sa.PrimaryKeyConstraint('course_data_id', 'restriction_id')
    )
    op.create_table('tbl_meeting',
    ...
    op.create_table('tbl_word_course_data',
    sa.Column('word_id', sa.Integer(), nullable=False),
    sa.Column('course_data_id', sa.Integer(), nullable=False),
    sa.Column('count', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['course_data_id'], ['tbl_course_data.course_data_id'], ),
    sa.ForeignKeyConstraint(['word_id'], ['tbl_word.word_id'], ),
